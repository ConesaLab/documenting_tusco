...
ctx$save_plot(combined, "fig-s7.pdf", width = ctx$params$width, height = ctx$params$height, units = "in", device = pdf_device)
ctx$save_plot(combined, "fig-s7.png", width = ctx$params$width, height = ctx$params$height, units = "in", dpi = 300)
