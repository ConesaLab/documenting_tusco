...
```bash
cd reviewer_response/round_1/analysis/review_plots/reviewer3/TSS
...
- Used in reviewer response document: `reviewer_response/round_1/src/reviewer_response.tex` (lines 569-589)
