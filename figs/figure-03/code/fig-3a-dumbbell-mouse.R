...
###############################################################
# Figure 3A Mouse (Alternative) - Dumbbell metrics plot
# Reads existing fig-3a-mouse.tsv and renders a facet dumbbell plot
# Usage: Rscript fig-3a-dumbbell-mouse.R [output_dir] [width] [height]
###############################################################
...
input_tsv <- file.path(tsv_dir, "fig-3a-mouse.tsv")
...
type_colors <- c("SIRVs" = "#cab2d6", "TUSCO" = "#1b9e77")
...
out_pdf <- file.path(plot_dir, "fig-3a-mouse-dumbbell.pdf")
...
out_png <- file.path(plot_dir, "fig-3a-mouse-dumbbell.png")
