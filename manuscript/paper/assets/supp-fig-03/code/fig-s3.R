...
# Save figure
ggsave(file.path(plot_dir, "fig-s3.pdf"), p_combined, width = 12, height = 5, device = "pdf")
cat("Saved figure:", file.path(plot_dir, "fig-s3.pdf"), "\n")

ggsave(file.path(plot_dir, "fig-s3.png"), p_combined, width = 12, height = 5, dpi = 300)
cat("Saved PNG:", file.path(plot_dir, "fig-s3.png"), "\n")
