...
tss_dir <- file.path(reviewer3_root, "TSS")
sirv_dir <- file.path(reviewer3_root, "expression", "lrgasp_evaluation")
splice_dir <- file.path(reviewer3_root, "splice")
alphagenome_dir <- file.path(reviewer3_root, "alphagenome")
...
ctx$save_plot(combined, "fig-r3-parameter-selection.pdf", width = ctx$params$width, height = ctx$params$height, units = "in", device = pdf_device)
ctx$save_plot(combined, "fig-r3-parameter-selection.png", width = ctx$params$width, height = ctx$params$height, units = "in", dpi = 300)
