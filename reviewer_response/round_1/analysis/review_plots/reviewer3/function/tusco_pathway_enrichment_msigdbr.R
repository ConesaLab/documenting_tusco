...
if (length(args) > 0 && any(args %in% c("-h", "--help"))) {
  cat(
    ...
    "\nDefaults:\n",
    "  --outdir reviewer_response/round_1/analysis/review_plots/reviewer3/function\n",
...
outdir <- parse_flag_value("--outdir", "reviewer_response/round_1/analysis/review_plots/reviewer3/function")
